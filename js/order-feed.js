...
(function () {
  ...
  // ── Short ID (4 karakter terakhir UUID) ───────────────────────────
  function shortId(id) {
  ...
  function statusBadge(status) {
    if (status === 'selesai') return '<span class="of-badge of-badge--selesai">✓</span>';
    if (status === 'pending') return '<span class="of-badge of-badge--pending">⏳</span>';
  ...
  function renderSkeletons(tbody, count = 6) {
    tbody.innerHTML = '';
    for (let i = 0; i < count; i++) {
      ...
      tr.innerHTML = `
        ...
        <td><div class="of-skel-line" style="width:36px"></div></td>
