/* ================================================================
   admin-collapse.js  —  Collapsible Cards + Sidebar Accordion
...
(function () {
  ...
  /* ================================================================
     ...
     Used by: "Collapsible content blocks" pattern
  ...
  function initSectionBlocks() {
    document.querySelectorAll('.section-block-header').forEach(function (header) {
      ...
      var blockId = 'sb-' + (header.querySelector('.section-block-title')?.textContent.trim().replace(/\s+/g, '-').toLowerCase() || Math.random().toString(36).slice(2));
  ...
  /* ================================================================
     ...
     (e.g. from admin-shop.js, admin-orders.js)
     ================================================================ */
